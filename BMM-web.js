...
jQuery(document).ready(function() {
	...
	legend.onAdd = function (map) {
		...
		<option disable value=\'{\"folderDens\":\"Density_simulationMap_ImageOverlay/\",\"folderFlight\":\"Quiver_sim/\",\"minval\":\"0\",\"maxval\":\"3\",\"titleval\":\"Bird Density [Log bird/km<sup>2</sup>]\"}\' >Simulation</option>\
		...
		<label class="checkbox-inline"><input type="checkbox" checked id="checkbox2">Rain (>0.01mm/hr)</label>\
		...
		<div class="checkbox"><label class="checkbox-inline"><input type="checkbox" checked id="checkbox1">Flight vectors</label></div>\
		</div></div>';*/

		div.innerHTML += '<div id="learnmore-div" class="form-control">\
		<a role="button" class="btn btn-default btn-sm" title="Instructions" id="modal"><i class="fas fa-info-circle"></i></a>\
		<a role="button" class="btn btn-default btn-sm" title="Description and code of the model" href="https://Rafnuss-PostDoc.github.io/BMM/" target="_blank"><i class="fas fa-atom"></i></a>\
		<a role="button" class="btn btn-default btn-sm" title="Code for the interface" href="https://github.com/Rafnuss-PostDoc/BMM-web" target="_blank"><i class="fab fa-github"></i></a>\
		<a role="button" class="btn btn-default btn-sm" title="Matlab Livescript of the model" href="https://Rafnuss-PostDoc.github.io/BMM/html/Density_modelInf_crossValid" target="_blank"><img width="20" src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/21/Matlab_Logo.png/267px-Matlab_Logo.png"></a>\
		<a role="button" class="btn btn-default btn-sm" title="Researchgate project webpage" href="https://www.researchgate.net/project/Bird-Migration-Modelling-BMM" target="_blank"><i class="fab fa-researchgate"></i></a>\
		</div>';
		return div;
	};
	legend.addTo(map);
	...
	var canvas = document.getElementById('canvas_spectral');
	var ctx = canvas.getContext('2d');
	var gradient = ctx.createLinearGradient(0, 0, 247, 0);
	...
	jQuery('#modal').on('click',function(){
		map.fire('modal', {
			content: '<h1>Instructions</h1>'+
			'<p>See <a href="https://github.com/Rafnuss-PostDoc/BMM-web">https://github.com/Rafnuss-PostDoc/BMM-web</a></p>',
		});
	})
	...
	map.on(L.Draw.Event.CREATED, function (e) {
		...
		draw_count++;
		e.layer.bindPopup('<span id="spinner-'+draw_count+'"><i class="fa fa-spinner fa-pulse fa-3x fa-fw"></i> Computing on the server for this location, can take up to 1min pour large zone.</span>')
		...
		jQuery.getJSON(link, function(data){
			...
			jQuery('#spinner-'+draw_count).remove();
			e.layer.closePopup();
		})
	});
	...
	jQuery.getJSON("https://bmm.raphaelnussbaumer.com/data/exportEst_time.json",function(data){
		est_time=data[0];

		jQuery.getJSON("https://bmm.raphaelnussbaumer.com/data/exportSim_time.json",function(data){
			...
			jQuery.getJSON('https://bmm.raphaelnussbaumer.com/data/global.json', function(data){
